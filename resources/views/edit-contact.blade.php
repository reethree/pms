...
<head>
  ...
  <meta http-equiv="X-UA-Compatible" content="IE=edge">
    ...
    <title>Edit Contact Page | Polimerindo</title>
        ...
        <div class="row">
            <div class="col-md-12">
                <div class="form-group" style="display: flex;">
                    ...
                    <div class="col-sm-8">
                        <input type="text" name="nama" class="form-control" id="name" required value="{{$contact->nama}}">
                    </div>
                </div>
                <div class="form-group" style="display: flex;">
                    <label class="col-sm-3 control-label">Perusahaan</label>
                    <div class="col-sm-8">
                        <input type="text" name="perusahaan" class="form-control" required value="{{$contact->perusahaan}}">
                    </div>
                </div>
                <div class="form-group" style="display: flex;">
                    <label class="col-sm-3 control-label">No. HP/Tlp</label>
                    <div class="col-sm-8">
                        <input type="tel" name="phone" class="form-control" required value="{{$contact->phone}}">
                    </div>
                </div>
                <div class="form-group" style="display: flex;">
        ...
        <div class="row">
            <div class="col-md-12">
                <div class="form-group" style="display: flex;">
                    ...
                    <div class="col-sm-8">
                        <input type="text" name="barang" class="form-control" required value="{{$contact->barang}}">
                    </div>
                </div>
                <div class="form-group" style="display: flex;">
                    <label class="col-sm-3 control-label">Fungsi Barang</label>
                    <div class="col-sm-8">
                        <input type="text" name="fungsi_barang" class="form-control" required value="{{$contact->fungsi_barang}}">
                    </div>
                </div>
                <div class="form-group" style="display: flex;">
                    <label class="col-sm-3 control-label">Material</label>
                    <div class="col-sm-8">
                        <input type="text" name="material" class="form-control" required value="{{$contact->material}}">
                    </div>
                </div>
                <div class="form-group" style="display: flex;">
                    <label class="col-sm-3 control-label">Warna</label>
                    <div class="col-sm-8">
                        <input type="text" name="warna" class="form-control" required  value="{{$contact->warna}}">
                    </div>
                </div>
                <div class="form-group" style="display: flex;">
                    <label class="col-sm-3 control-label">Mold</label>
                    <div class="col-sm-8">
                        <input type="text" name="mold" class="form-control" id="name" required value="{{$contact->mold}}">
                    </div>
                </div>
                <div class="form-group" style="display: flex;">
                    ...
                    <div class="col-sm-8">
                        <div class="input-group">
                            <input type="text" name="quantity" class="form-control" required value="{{$contact->quantity}}">
                ...
                <div class="form-group" style="display: flex;">
                    ...
                    <div class="col-sm-8">
                        <input type="checkbox" name="rutin" value="1" {{ ($contact->rutin == 1) ? 'checked' : '' }} />
                    </div>
                </div>
                <div class="form-group" style="display: flex;">
                    ...
                    <div class="col-sm-8">
                        <div class="input-group">
                            ...
                            <input type="text" name="target_harga" class="form-control money" value="{{number_format($contact->target_harga)}}">
                        </div>
                    </div>
                </div>
                <div class="form-group" style="display: flex;">
                    ...
                    <div class="col-sm-8">
                        <div class="input-group date">
                            ...
                            <input type="text" name="target_produksi" class="form-control datepicker" required value="{{$contact->target_produksi}}">
                        </div>
                    </div>
                </div>
                <div class="form-group" style="display: flex;">
                    ...
                    <div class="col-sm-8">
                        <input type="text" name="packaging" class="form-control" required value="{{$contact->packaging}}">
                    </div>
                </div>
                <div class="form-group" style="display: flex;">
                ...
                <div class="form-group" style="display: flex;">
                    ...
                    <div class="col-sm-8">
                        <textarea name="referensi" class="form-control">{{$contact->referensi}}</textarea>
                    </div>
                </div>
                <div class="form-group" style="display: flex;">
                    <label class="col-sm-3 control-label">Catatan</label>
                    <div class="col-sm-8">
                        <textarea name="catatan" class="form-control">{{$contact->catatan}}</textarea>
                    </div>
                </div>
            </div>
        </div>
                ...
                <div class="form-group" style="display: flex;">
                    ...
                    <div class="col-sm-8">
                        <div class="input-group date">
                            ...
                            <input type="text" name="tgl_tlp" class="form-control datepicker" required value="{{$contact->tgl_tlp}}">
                        </div>
                    </div>
                </div>
                <div class="form-group" style="display: flex;">
                    ...
                    <div class="col-sm-8">
                        <input type="text" name="penerima_tlp" class="form-control" required value="{{$contact->penerima_tlp}}">
                    </div>
                </div>
            </div>
        </div>
