...
<div class="box box-default">
    ...
    <!-- /.box-header -->
    <form class="form-horizontal" action="{{ route('store-labour') }}" enctype="multipart/form-data" method="POST">
        <div class="box-body">            
            <div class="row">
                <div class="col-md-6">
                    ...
                    <div class="form-group">
                      ...
                      <div class="col-sm-8">
                          <input type="number" name="number_of_employee" class="form-control" id="number_of_employee" placeholder="No. of Employee" required>
                      </div>
                    </div>
                    <div class="form-group">
                      ...
                      <div class="col-sm-8">
                          <div class="input-group">
                            ...
                            <input type="text" name="weekly_wages" class="form-control money" id="weekly_wages" placeholder="Weekly Wages" required>
                          </div>
                      </div>
                    </div>
                    <div class="form-group">
                      ...
                      <div class="col-sm-8">
                          <input type="number" name="work_hour" class="form-control" id="work_hour" placeholder="Work Hour" required>
                      </div>
                    </div>
                    <div class="form-group">
