...
<div class="box box-default">
    ...
    <!-- /.box-header -->
    <form class="form-horizontal" action="{{ route('store-mould') }}" enctype="multipart/form-data" method="POST">
        <div class="box-body">            
            <div class="row">
                <div class="col-md-6">
                    ...
                    <div class="form-group">
                      ...
                      <div class="col-sm-8">
                          <input type="number" name="no_of_cavity" class="form-control" id="no_of_cavity" placeholder="Number of Cavity" required>
                      </div>
                    </div>
                    <div class="form-group">
