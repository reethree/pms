...
<div class="box box-default">
    ...
    <!-- /.box-header -->
    <form class="form-horizontal" action="{{ route('store-electricity') }}" enctype="multipart/form-data" method="POST">
        <div class="box-body">            
            <div class="row">
                <div class="col-md-6">
                    ...
                    <div class="form-group">
                      ...
                      <div class="col-sm-8">
                          <div class="input-group">
                            ...
                            <input type="text" name="monthly_bill" class="form-control money" id="monthly_bill" placeholder="Monthly Bill" required>
                          </div>
                      </div>
                    </div>
<!--                    <div class="form-group">
